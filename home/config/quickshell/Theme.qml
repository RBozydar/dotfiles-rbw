...
Singleton {
    ...
    readonly property color onPrimary: roleColor("onPrimary", "#003731", "#ffffff")
    readonly property color primaryContainer: roleColor("primaryContainer", "#1b3b36", "#cbe7e1")
    readonly property color onPrimaryContainer: roleColor("onPrimaryContainer", "#c8d2e0", "#132235")
    readonly property color secondary: roleColor("secondary", "#01ccff", "#0077cc")
    readonly property color onSecondary: roleColor("onSecondary", "#003547", "#ffffff")
    readonly property color secondaryContainer: roleColor("secondaryContainer", "#1a2b44", "#cedceb")
    readonly property color onSecondaryContainer: roleColor("onSecondaryContainer", "#c8d2e0", "#132235")
    readonly property color tertiary: roleColor("tertiary", "#fb958b", "#cf6b5d")
    readonly property color onTertiary: roleColor("onTertiary", "#4f1d17", "#ffffff")
    readonly property color tertiaryContainer: roleColor("tertiaryContainer", "#5e2a22", "#f9d4ce")
    readonly property color onTertiaryContainer: roleColor("onTertiaryContainer", "#ffd7d1", "#132235")
    readonly property color error: roleColor("error", "#ff857d", "#d64f44")
    readonly property color onError: roleColor("onError", "#601410", "#ffffff")
    readonly property color errorContainer: roleColor("errorContainer", "#7f221a", "#f9d4ce")
    readonly property color onErrorContainer: roleColor("onErrorContainer", "#ffdad6", "#132235")
    readonly property color background: roleColor("background", "#09111f", "#edf4fb")
    readonly property color onBackground: roleColor("onBackground", "#c8d2e0", "#132235")
    readonly property color surface: roleColor("surface", "#d9111827", "#eef7fbff")
    readonly property color onSurface: roleColor("onSurface", "#c8d2e0", "#132235")
    readonly property color surfaceVariant: roleColor("surfaceVariant", "#111827", "#ffffff")
    readonly property color onSurfaceVariant: roleColor("onSurfaceVariant", "#8ea4bf", "#5d7389")
