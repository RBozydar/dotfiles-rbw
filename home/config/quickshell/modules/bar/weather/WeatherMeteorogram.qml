...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            function strokeHorizontalGrid(top, height, steps, alpha) {
                ctx.strokeStyle = root.rgba(Theme.border, alpha);
                ctx.lineWidth = 1;
            ...
            for (let index = 0; index < root.sampleCount; index += 3) {
                ...
                const segments = [
                    [root.tempTop, root.tempBottom],
                    [root.precipTop, root.precipBottom],
                    [root.pressureTop, root.pressureBottom],
                    [root.windTop, root.windBottom],
                    [root.cloudTop, root.cloudBottom]
                ];
            ...
            if (root.sampleCount > 1) {
                ...
                ctx.closePath();
                ctx.fillStyle = root.rgba(Theme.warning, 0.18);
                ctx.fill();
            }
            ...
            ctx.lineWidth = 1.5;
            ctx.strokeStyle = root.rgba(Theme.accentStrong, 0.9);
            ctx.stroke();
            ...
            ctx.lineWidth = 2.6;
            ctx.strokeStyle = root.rgba(Theme.warning, 0.98);
            ctx.stroke();
            ...
            for (let index = 0; index < root.sampleCount; index += 3) {
                ...
                ctx.fillStyle = root.rgba(Theme.panelSolid, 0.95);
                ctx.fill();
                ctx.lineWidth = 2;
                ctx.strokeStyle = root.rgba(Theme.warning, 0.95);
                ctx.stroke();
            }
            ...
            for (let index = 0; index < root.sampleCount; index += 1) {
                ...
                const barWidth = Math.max(6, root.chartWidth / Math.max(root.sampleCount, 18) * 0.58);
                    ...
                    ctx.fillStyle = root.rgba(Theme.accentStrong, 0.82);
            ...
            ctx.lineWidth = 1.8;
            ctx.strokeStyle = root.rgba(Theme.warning, 0.9);
            ctx.stroke();
            ...
            if (root.sampleCount > 1) {
                ...
                ctx.closePath();
                ctx.fillStyle = root.rgba(Theme.warning, 0.26);
                ctx.fill();
            }
            ...
            ctx.lineWidth = 1.8;
            ctx.strokeStyle = root.rgba(Theme.warning, 0.92);
            ctx.stroke();
            ...
            if (root.sampleCount > 1) {
                ...
                ctx.closePath();
                ctx.fillStyle = root.rgba(Theme.accentStrong, 0.24);
                ctx.fill();
            }
            ...
            ctx.lineWidth = 1.8;
            ctx.strokeStyle = root.rgba(Theme.accentStrong, 0.95);
            ctx.stroke();
            ...
            if (root.sampleCount > 1) {
                ...
                ctx.closePath();
                ctx.fillStyle = root.rgba(Theme.text, 0.2);
                ctx.fill();
            }

            const cloudLines = [
                ["cloudLow", Theme.accentStrong, 0.95],
                ["cloudMid", Theme.accent, 0.9],
                ["cloudHigh", Theme.textMuted, 0.9]
            ];
    ...
    Repeater {
        ...
        delegate: Text {
            ...
            color: index === 0 ? Theme.warning : Theme.textMuted
            font.family: Theme.fontMono
            font.pixelSize: 10
        }
    }
    ...
    Repeater {
        ...
        delegate: Text {
            ...
            color: index === 0 ? Theme.accentStrong : Theme.textMuted
            font.family: Theme.fontMono
            font.pixelSize: 10
        }
    }
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            Text {
                ...
                color: (parent.sample?.windGustKmh ?? 0) > 30 ? Theme.warning : Theme.accentStrong
                font.family: Theme.fontSans
                font.pixelSize: 14
    ...
    Rectangle {
        ...
        color: Qt.rgba(Theme.panelSolid.r, Theme.panelSolid.g, Theme.panelSolid.b, 0.96)
        border.width: 1
